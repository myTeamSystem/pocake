                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li> <?= $this->Html->link('Listar usuarios', ['controller' => 'Users', 'action' => 'list']) ?> </li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    <li>
                        <?= $this->Html->link('Mi lista marks', ['controller' => 'bookmarks', 'action' => 'index'])?>
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li><?= $this->Html->link(__('Cerrar seseion'), ['controller' => 'Users', 'action' => 'logout']) ?></li>
                </ul>
            </div>
        </div>
    </nav>
